...
//    cv::Mat TrackStereo(const cv::Mat &imLeft, const cv::Mat &imRight, const double &timestamp, const vector<IMU::Point>& vImuMeas = vector<IMU::Point>(), string filename="");
    cv::Mat TrackStereo(const cv::Mat &imLeft, const cv::Mat &imRight, const double &timestamp, const vector<IMU::Point>& vImuMeas = vector<IMU::Point>());
    ...
    cv::Mat TrackStereo_RGBD(const cv::Mat &imLeft, const cv::Mat &imRight, const cv::Mat &depthmap, const double &timestamp, string filename="");
...
//    cv::Mat TrackMonocular(const cv::Mat &im, const double &timestamp, const vector<IMU::Point>& vImuMeas = vector<IMU::Point>());
    ...
    void SetPointerToTrack(PythonClient* pPythonClient);
//    {
//        mpTracker->mpPythonClient = pPythonClient;
//    }
