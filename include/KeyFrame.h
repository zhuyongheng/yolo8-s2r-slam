...
public:
    ...
    KeyFrame(Frame &F, Map* pMap, KeyFrameDatabase* pKFDB, const cv::Mat &imgRGB, const cv::Mat &imgRGB_r);
...
//    void SetKeyFrame(PythonClient* pPythonClient)
//    {
//        mpPythonClient = pPythonClient;
//    }
