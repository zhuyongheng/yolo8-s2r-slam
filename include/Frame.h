...
public:
    ...
    Frame(const cv::Mat &imLeft, const cv::Mat &imRight, const double &timeStamp, ORBextractor* extractorLeft, ORBextractor* extractorRight, ORBVocabulary* voc, cv::Mat &K, cv::Mat &distCoef, const float &bf, const float &thDepth, GeometricCamera* pCamera,Frame* pPrevF = static_cast<Frame*>(NULL), const IMU::Calib &ImuCalib = IMU::Calib(), const PythonClient* pPythonClient = static_cast<PythonClient*>(NULL));

    Frame(const cv::Mat &imLeft, const cv::Mat &imRight, PythonClient* P, const double &timeStamp, ORBextractor* extractorLeft, ORBextractor* extractorRight, ORBVocabulary* voc, cv::Mat &K, cv::Mat &distCoef, const float &bf, const float &thDepth, GeometricCamera* pCamera,Frame* pPrevF = static_cast<Frame*>(NULL), const IMU::Calib &ImuCalib = IMU::Calib());
//    Frame(const cv::Mat &imLeft, const cv::Mat &imRight, const cv::Mat &imgRGB, PythonClient* P, const double &timeStamp, ORBextractor* extractorLeft, ORBextractor* extractorRight, ORBVocabulary* voc, cv::Mat &K, cv::Mat &distCoef, const float &bf, const float &thDepth, GeometricCamera* pCamera,Frame* pPrevF = static_cast<Frame*>(NULL), const IMU::Calib &ImuCalib = IMU::Calib());
    Frame(const cv::Mat &imLeft, const cv::Mat &imRight, const cv::Mat &imgRGB, PythonClient* P, const double &timeStamp, ORBextractor* extractorLeft, ORBextractor* extractorRight, ORBVocabulary* voc, cv::Mat &K, cv::Mat &distCoef, const float &bf, const float &thDepth, GeometricCamera* pCamera, Tracking* pTracker, Frame* pPrevF = static_cast<Frame*>(NULL), const IMU::Calib &ImuCalib = IMU::Calib());
    ...
    // 双目RGBD
    Frame(const cv::Mat &imLeft, const cv::Mat &imRight, const cv::Mat &imDepth, const double &timeStamp, ORBextractor* extractorLeft, ORBextractor* extractorRight, ORBVocabulary* voc, cv::Mat &K, cv::Mat &distCoef, const float &bf, const float &thDepth, GeometricCamera* pCamera,Frame* pPrevF = static_cast<Frame*>(NULL), const IMU::Calib &ImuCalib = IMU::Calib());
    ...
    void checkBoundingBox(map<string, vector<string>>  boundingboxinfo);
    ...
    void CalculEverything(const cv::Mat &imLeft,const cv::Mat &imRight);
    int CheckMovingKeyPoints(const cv::Mat &imGray, std::vector<cv::KeyPoint>& mvKeysT,std::vector<cv::Point2f> T);

    void ProcessMovingObject(const cv::Mat &imgray );
    int CheckMovingKeyPoints(const cv::Mat &imrgbd, const cv::Mat &imGray, std::vector<std::vector<cv::KeyPoint>>& mvKeysT,std::vector<cv::Point2f> T);
    ...
    std::vector<std::vector<cv::KeyPoint>> mvKeysTempRight;
...
public:
    ...
    //mvKeys:原始左图像提取出的特征点（未矫正）
    //mvKeysRight:原始右图像提取出的特征点（未矫正）
    //mvKeysUn:矫正mvkeys后的特征的, 对于双目摄像头,一般得到的图像都是矫正好的,再矫正一次有点多余
...
public:
    ...
    cv::Mat imgLeft, imgRight, imgRGB;
    cv::Mat Object_Detect;
